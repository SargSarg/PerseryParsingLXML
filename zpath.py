...
ul = tree.findall(
    'body/div/div[3]/div/section/div[3]/div[1]/div/ul/li') #xpath
...
#Сделать так чтоб показывало еще и дату добавления новости
...
####################################################################
#Написать программу достающую спомощью парсера Lxml текст из tag2 в вот таком HTML
#<html>
